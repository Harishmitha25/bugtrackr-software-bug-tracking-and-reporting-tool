...
const MentionedBugsList = ({ onSelectBug }) => {
      ...
      .catch((err) =>
        setError(
          err.response?.data?.error ||
            ...
            "Failed to fetch mentioned bugs"
        )
      );
  }, []);
  ...
  }, [searchQuery, searchMode, allBugs]);
  ...
  const handleSemanticSearch = () => {
    if (searchQuery.trim()) {
      ...
      debouncedSemanticSearch(searchQuery, app, setBugs, setError);
    }
  };
  ...
  return (
    <>
      <Box sx={{ p: 3 }}>
        ...
        {/* Alert helper when semantic search is selected */}
        {searchMode === "semantic" && (
          <Typography
            variant="body2"
        ...
        >
          ...
          <Box display="flex" gap={2} mb={2}>
            <Button
              ...
              color="primary"
              onClick={() =>
                exportToCSV(filteredBugs, "mentioned_bugs", headers, mapper)
              }
            >
              Export CSV
            </Button>
            ...
            <Button
              ...
              color="secondary"
              onClick={() =>
                exportToPDF(filteredBugs, "mentioned_bugs", headers, mapper)
              }
            >
              Export PDF
            </Button>
...
export default MentionedBugsList;
